<%-- 
    Document   : viewColl
    Created on : Mar 21, 2011, 12:43:37 AM
    Author     : Vinnu
--%>
    ...
    <body id="body" >
        ...
        <div class="content">
            <form action="#" method="post">
                ...
                <input type="text" name="collid" value="<%=request.getParameter("cid")%>" size="1" readonly /><br/><br/>
                <label>College Name : </label>
                <input type="text" name="cname" value="<%=request.getParameter("cname")%>" size="60" readonly/><br/><br/>
                <label>College Address : </label>
                <input type="text" name="cadd" value="<%=request.getParameter("cadd")%>" size="60" readonly/><br/><br/>
                <h2>Course List</h2>
