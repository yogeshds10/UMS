<%-- 
    Document   : calogin
    Created on : May 13, 2011, 6:25:10 PM
    Author     : Vinnu
--%>
...
<html>
    ...
    <body id="body" >
        ...
        <div class="content">
            <form action="LoginHandler?type=2" method="post">
                <h1>College Administrator's Login</h1><br/>
                <label>Username : </label><input type="text" name="cuname" /><br/><br/>
                <label>Password : </label><input type="password" name="cpasswd" /><br/><br/>
