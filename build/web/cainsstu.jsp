<%-- 
    Document   : cainsstu
    Created on : Jun 1, 2011, 10:51:04 AM
    Author     : Vinnu
--%>
...
<html>
    <head>
        ...
        <%
            ...
            try {
                ...
                rs = st.executeQuery("select collid,collname from uec.college where cuname='" + session.getAttribute("uid") + "'");
        %>
    ...
    <body id="body">
        ...
        <div class="content">
            ...
            %>
            <form action="cainsstu2.jsp" method="post" id="form1">
                <h1>Insert new student</h1><br/>
                <label>First Name : </label><input type="text" name="fname" id="fname" size="60"/><br/><br/>
                <label>Last Name :  </label><input type="text" name="lname" id="lname" size="60"/><br/><br/>
